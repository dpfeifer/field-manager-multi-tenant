...
Two plans, one flat price, no per-user fees and no sales call.

| | Free | Pro |
|---|---|---|
| Price | $0 | **{{price}} a month, flat**{{offer_note}} |
| Customers | Up to 5 | Unlimited |
| Jobs | Up to 20 in total | Unlimited |
| Repeating schedules | Yes | Yes |
| Quotes | Yes | Yes |
...
- Up to 5 customers and up to 20 jobs in total, with no time limit
...
**Extra users.** Most field-service software charges for each person you add. On Pro, Field Manager does not. A crew of eight pays what a solo operator pays.

**Payments.** Field Manager does not process payments and takes no percentage. Customers pay you through your own Stripe, PayPal, Square or Venmo account, at whatever rate that provider charges you.

**Setup or migration.** Sending us your customer list to load is free.
...
A: No. Team members are part of Pro, and Pro is one flat price however many people you add.
Q: Does Field Manager take a percentage of payments?
A: No. It does not process payments. Invoices link to your own payment account, and you pay only what that provider charges.
Q: Can I cancel any time?
A: Yes. Cancel from the Billing screen. Cancellation takes effect at the end of the current billing period, partial months are not refunded, your data is kept, and the account moves to the Free plan.
Q: Is there a contract or a setup fee?
A: No contract and no setup fee. Loading your existing customer list is free.
{{/faq}}

<div class="cta">Start on the free plan. <a href="/signup">Start free — no card needed</a> or <a href="/demo">try the live demo</a>.</div>
